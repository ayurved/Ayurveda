...
angular.module('articles.module', [])
	.directive('articleItem', ['$sce', '$filter', 'Language', 'Article', function($sce, $filter, Language, Article){
		return {
		    restrict: 'A',
		    templateUrl: CB.admin_assets_url + '/js/app/articles/templates/article-listing-item.html',
		    scope: {
		      item: '=',
		      language: '=',
		      searchquery: '='
