define([
    ...
    App.controller('galleriesController', ['$scope', 'Language', 'GalleryPage',  function($scope, Language, GalleryPage){
        ...
        Language.get().then(
            ...
            function(response){
                console.log(response, 'galleriesController - languages not loaded');
            }
        );
        ...
        var GalleryModel = new GalleryPage();
        GalleryModel.getAll().then(function(data){
