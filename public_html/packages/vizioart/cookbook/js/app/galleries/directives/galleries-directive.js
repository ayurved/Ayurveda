define([
	...
	'app/gallery/models/gallery-model',
], function ($, _, angular) {


angular.module('galleries.module', [])
	.directive('galleryItem', ['$sce', '$filter', 'Language', 'Gallery', function($sce, $filter, Language, Gallery){
		return {
		    restrict: 'A',
		    templateUrl: CB.admin_assets_url + '/js/app/galleries/templates/gallery-listing-item.html',
		    scope: {
		      item: '=',
		      language: '=',
		      searchquery: '='
		    ...
		    controller: function($scope){
		    	...
		    	$scope.getEditLink = function(){
		    		var url = CB.admin_url + '/galleries/edit/' + $scope.item.id;
		    		return url;
		    	}
