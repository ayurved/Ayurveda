				...
				<div class="col-lg-5 col-md-4">
					...
					<div class="row">
						...
						<div class="col-lg-6 col-md-12">
							...
							<!-- POST STATUS -->
							<div post-status="Article.form.activeContent.status" 
								 post-created-at="Article.form.activeContent.created_at" 
								 post-model-status="Article.model.activeContent.status" 
